...
INSERT OR REPLACE INTO tokens (
  ...
  ('token-pixel', 'Pixel Grove', 'PXG', 'Polygon', '0x9000000000000000000000000000000000000004', 'https://api.dicebear.com/9.x/shapes/svg?seed=pxg', 'https://demo.kairo.local/tokens/pxg', 'https://x.com/pixelgrove', 'https://t.me/pixelgrove', 'breakout', '2026-06-20T11:15:00.000Z', '2026-06-26T10:00:00.000Z'),
  ('token-neon', 'Neon Keepers', 'NEON', 'Optimism', '0x7000000000000000000000000000000000000005', 'https://api.dicebear.com/9.x/shapes/svg?seed=neon', 'https://demo.kairo.local/tokens/neon', 'https://x.com/neonkeepers', 'https://t.me/neonkeepers', 'genesis_candidate', '2026-06-20T11:20:00.000Z', '2026-06-26T10:00:00.000Z'),
...
INSERT OR REPLACE INTO bounties (
  ...
  ('bounty-pxg-ugc', 'token-pixel', 'user-demo-admin', 'Pixel Grove UGC Quest Engine', 'Prototype a quest engine that rewards holders for remixing Pixel Grove assets and posting verified creations.', '12,500 PXG + merch pool', 'hybrid', 'verified', 'quests@pixel.demo', '2026-07-30T23:59:59.000Z', 'active', 88, 13450, 1, 1, '2026-06-21T13:00:00.000Z', '2026-06-26T10:00:00.000Z'),
...
INSERT OR REPLACE INTO support_events (
  ...
  ('support-event-001', 'user-demo-supporter', 'boost', 'bounty', 'bounty-dorm-miniapp', 'bounty-dorm-miniapp', NULL, NULL, 10, 'valid', 'homepage_banner', '{"label":"Banner boost"}', '2026-06-25T08:00:00.000Z'),
  ('support-event-002', 'user-demo-supporter', 'boost', 'submission', 'submission-dorm-pulsebot', 'bounty-dorm-miniapp', 'submission-dorm-pulsebot', NULL, 15, 'valid', 'submission_card', '{"label":"Builder support"}', '2026-06-25T08:10:00.000Z'),
  ...
  ('support-event-004', 'user-demo-builder', 'boost', 'bounty', 'bounty-ember-reputation', 'bounty-ember-reputation', NULL, 'user-demo-supporter', 10, 'valid', 'referral', '{"campaign":"ember-revival"}', '2026-06-25T09:00:00.000Z'),
  ('support-event-005', 'user-demo-admin', 'boost', 'submission', 'submission-pxg-remix', 'bounty-pxg-ugc', 'submission-pxg-remix', NULL, 15, 'valid', 'admin_review', '{"note":"Featured win"}', '2026-06-25T09:30:00.000Z'),
  ('support-event-006', 'user-demo-supporter', 'boost', 'bounty', 'bounty-atlas-indexer', 'bounty-atlas-indexer', NULL, NULL, 10, 'valid', 'dormant_giants', '{"rank":2}', '2026-06-25T10:00:00.000Z'),
...
INSERT OR REPLACE INTO escrow_events (
  ...
  ('escrow-event-atlas-funded', 'bounty-atlas-indexer', 'user-demo-admin', 'internal_funding_deposited', '4,000 USDC', 'https://demo.kairo.local/proofs/atlas-funded', 'Funding event: stablecoin escrow received and tagged to Atlas indexer bounty.', '2026-06-22T09:00:00.000Z'),
  ...
  ('escrow-event-lumen-funded', 'bounty-lumen-audit', 'user-demo-admin', 'internal_funding_deposited', '6,500 USDC', 'https://demo.kairo.local/proofs/lumen-funded', 'Funding event: reserve audit widget bounty escrowed pending submissions.', '2026-06-23T12:00:00.000Z');
